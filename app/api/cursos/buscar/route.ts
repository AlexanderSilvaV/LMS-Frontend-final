...
export async function POST(request: NextRequest) {
  try {
    console.log('POST /api/cursos/buscar - Iniciando solicitud')
    ...
    const backendUrl = `${BACKEND_BASE_URL}/api/Cursos/buscar`
    ...
    console.error('Error en POST /api/cursos/buscar:', error)
    return NextResponse.json(
