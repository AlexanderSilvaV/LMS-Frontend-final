...
export async function GET(request: NextRequest) {
  try {
    console.log('GET /api/cursos - Iniciando solicitud')
    ...
    const backendUrl = `${BACKEND_BASE_URL}/api/Cursos${queryString ? `?${queryString}` : ''}`
...
export async function POST(request: NextRequest) {
  try {
    console.log('POST /api/cursos - Iniciando solicitud')
    ...
    const backendUrl = `${BACKEND_BASE_URL}/api/Cursos`
    console.log('Backend URL:', backendUrl)
